...
window.onload = function(){
    ...
    document.getElementById("currentSong").innerHTML = musicname;
    var lyrics = document.getElementById("PageContext").value;
    var lyricFile = document.getElementById("lyricFile").value;
    var lyric = lyricFile.substring(0,lyricFile.indexOf('.'));
    var url = lyrics + "/home/lyrics?name="+lyric;
