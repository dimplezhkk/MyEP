                ...
                <form class="layui-form" method="post" enctype="multipart/form-data" id="file" action="#">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="username" value="${consumer.username}" name="username" placeholder="请输入用户账号" lay-reqtext="用户账号是必填项，岂能为空？" required="" lay-verify="required" autocomplete="off" class="layui-input">
                        </div>
                    ...
                    <input type="hidden" id="password" name="password" value="${consumer.password}" >
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="email" name="email" value="${consumer.email}" placeholder="请输入用户邮箱" required="" lay-verify="email" autocomplete="off" class="layui-input">
        ...
        layui.use(['form', 'layer','jquery'],
            function() {
                ...
                function(data) {
                    ...
                    $.ajax({
                    	type: 'post',
                        url: '${pageContext.request.contextPath}/consumer/editConsumer',
                        cache: false,
                        async: true,
                        data: selectedFile,
