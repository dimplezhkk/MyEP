...
.image:hover {
                ...
                <form class="layui-form" method="post" enctype="multipart/form-data" id="file" action="#">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline" style="width: 212px;">
                            <input type="text" id="musicname" name="musicname" placeholder="请输入歌曲名吧" required="" lay-verify="required" autocomplete="off" class="layui-input">
                        </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline" style="width: 186px;">
                            <input type="text" id="singer" name="singer" required="" placeholder="请输入歌手姓名吧" lay-verify="required" autocomplete="off" class="layui-input">
                       </div>
                    </div>
                    
                   <!--  <div class="layui-form-item">
                        <label for="album" class="layui-form-label">
                            <span class="x-red">*</span>专辑
                       </label>
                        <div class="layui-input-inline">
                            <input type="text" id="album" name="album" required="" placeholder="请输入专辑吧" lay-verify="required" autocomplete="off" class="layui-input">
                       </div>
                    </div> -->
                    ...
                    <div class="layui-inline">
				      <label class="layui-form-label"><span class="x-red">*</span>专辑</label>
					      <div class="layui-input-inline" style="padding-top: 15px;">
					        <select name="album" id="album" lay-verify="required" lay-search="">
                    ...
                    <div class="layui-inline" style="padding-top: 16px;">
                        ...
                        <div class="layui-input-inline" style="width: 186px;">
                            <input type="text" id="description" name="description" placeholder="请输入描述，建议20词之内" required="" lay-verify="required" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                   ...
                   <div class="layui-inline">
			        ...
			        <input placeholder="请输入歌词吧" value="LRC歌词暂未录入" type="hidden" id="lyric" name="lyric" class="layui-input"></input>
                    <div class="layui-form-item">
   ...
   /* $(function(){
	   var ajaxTimeOut=
	        $.ajax({
	        type:"post",
	        url:"${pageContext.request.contextPath}/music/addAlbum",
	        dataType:"json",
	        async:true,
	        cache:false,//不缓存
	        success:function(data)
	        {
	                for(var i=0;i<data.length;i++)
	                {
	                	...
	                	document.getElementById("albumList").appendChild(option);
        ...
        layui.use(['form', 'layer','jquery'],
            function() {
                ...
                function(data) {
                    ...
                    $.ajax({
                    	type: 'post',
                        url: '${pageContext.request.contextPath}/music/addMusic',
                        cache: false,
                        async: true,
                        data: selectedFile,
