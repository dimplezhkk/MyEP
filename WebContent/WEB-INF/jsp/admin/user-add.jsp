...
<meta name="renderer" content="webkit">
                ...
                <form class="layui-form" method="post" action="#">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="username" name="username" placeholder="请输入管理员账号" lay-reqtext="管理员账号是必填项，岂能为空？" required="" lay-verify="required" autocomplete="off" class="layui-input">
                        </div>
                   ...
                   <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="realname" name="realname" placeholder="请输入管理员真实姓名" required="" lay-verify="required" autocomplete="off" class="layui-input">
                        </div>
                   </div>
 ...
 <script type="text/javascript">
    ...
    $("#username").blur(function(){
      ...
      $.get(
              "${pageContext.request.contextPath}/admin/checkUsername",
