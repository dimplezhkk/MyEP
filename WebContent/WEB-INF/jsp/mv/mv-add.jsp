                ...
                <form class="layui-form" method="post" enctype="multipart/form-data" id="file" action="#">
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline" style="width: 186px;">
                            <input type="text" id="name" name="name"  placeholder="请输入MV名称" required="" lay-verify="required" autocomplete="off" class="layui-input">
                        </div>
                   ...
                   <div class="layui-inline">
                        ...
                        <div class="layui-input-inline" style="width: 186px;">
                            <input type="text" id="singer" name="singer" placeholder="请输入MV歌手" required="" lay-verify="required" autocomplete="off" class="layui-input">
                        </div>
                   </div>
                  ...
                  <div class="layui-inline" style="padding-top: 15px;">
                   ...
                   <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <button class="layui-btn" lay-filter="add" lay-submit="">增加MV</button>
        ...
        layui.use(['form', 'layer','jquery'],
            function() {
                ...
                function(data) {
                    ...
                    $.ajax({
                    	type: 'post',
                        url: '${pageContext.request.contextPath}/mv/addMusicVideo',
                        cache: false,
                        async: true,
                        data: selectedFile,
