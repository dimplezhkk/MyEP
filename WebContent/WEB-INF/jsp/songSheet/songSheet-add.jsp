                ...
                <form class="layui-form" method="post" enctype="multipart/form-data" id="file" action="#">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="creator" name="creator" placeholder="请输入创建人" required="" lay-verify="required" autocomplete="off" class="layui-input">
                        </div>
                   ...
                   <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="label" name="label" placeholder="请输入歌单标签" required="" lay-verify="required" autocomplete="off" class="layui-input">
                        </div>
                   </div>
        		  ...
        		  <div class="layui-form-item layui-form-text">
			            ...
			            <div class="layui-input-block">
			                <textarea placeholder="请输入歌单描述吧" id="description" name="description" class="layui-textarea"></textarea>
			            </div>
        		  </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <button class="layui-btn" lay-filter="add" lay-submit="">增加歌单</button>
        ...
        layui.use(['form', 'layer','jquery'],
            function() {
                ...
                function(data) {
                    ...
                    $.ajax({
                    	type: 'post',
                        url: '${pageContext.request.contextPath}/songSheet/addSongSheet',
                        cache: false,
                        async: true,
                        data: selectedFile,
