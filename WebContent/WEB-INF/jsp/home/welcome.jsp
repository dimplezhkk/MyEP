            ...
            <section>
              <section class="vbox">
                <section class="scrollable padder-lg w-f-md" id="bjax-target">
					...
					<div class="layui-carousel" id="test10" style="width: 1200px; height: 460px;padding-top: 25px;">
					  <div carousel-item="" style="width: 1200px; height: 460px">
					  <c:forEach items="${list}" var="rotation">
					    <div><img width="1200" height="460" src="http://localhost:8080/${rotation.image}"></div>
					    </c:forEach>
					  </div>
					</div>
                  <!-- /主体部分到此结束 -->
