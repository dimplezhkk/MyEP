            ...
            <section>
              <section class="vbox">
                <section class="scrollable padder-lg w-f-md" id="bjax-target">
                  ...
                  <h2 class="font-thin m-b">与我一同发现精彩 <span class="musicbar animate inline m-l-sm" style="width:20px;height:20px">
                  ...
                  <c:forEach items="${pageInfo.list}" var="music" >
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                      <div class="item">
                        <div class="pos-rlt">
                         <!--  <div class="bottom">
                            <span class="badge bg-info m-l-sm m-b-sm">歌曲时间03:20</span>
                          </div> -->
                          <div class="item-overlay opacity r r-2x bg-black">
                            ...
                            <div class="bottom padder m-b-sm">
                             <%--  <a href="${pageContext.request.contextPath}/home/showMusic?musicId=${music.id}" class="pull-right" target="_blank">
                          ...
                          <a href="${pageContext.request.contextPath}/home/showMusic?musicId=${music.id}" target="_blank"><img width="185px" height="280px" src="http://localhost:8080/${music.image}" alt="" class="r r-2x img-full"></a>
                        </div>
                        <div class="padder-v">
                          ...
                          <a href="${pageContext.request.contextPath}/home/showSingerInfo?singer=${music.singer}" class="text-ellipsis text-xs text-muted" target="_blank">${music.singer}</a>
                        </div>
                      </div>
                    </div>
                    </c:forEach>
                  ...
                  <div class="row">
                    <div class="col-md-7">
                      <h3 class="font-thin">新歌^_^</h3>
                      <div class="row row-sm">
                      <c:forEach items="${newInfo.list}" var="newInfo">
                        <div class="col-xs-6 col-sm-3">
                          <div class="item">
                            <div class="pos-rlt">
                              <div class="item-overlay opacity r r-2x bg-black">
                                <div class="center text-center m-t-n">
                                  <a href="${pageContext.request.contextPath}/home/showMusic?musicId=${newInfo.id}"
                                  target="_blank">
                              ...
                              <a href="${pageContext.request.contextPath}/home/showMusic?musicId=${newInfo.id}"
                              target="_blank">
                              <img src="http://localhost:8080/${newInfo.image}" width="158px" height="162px" alt="" class="r r-2x img-full"></a>
                            </div>
                            <div class="padder-v">
                              <a href="${pageContext.request.contextPath}/home/showMusicInfo?musicSinger=${newInfo.singer}&musicName=${newInfo.musicname}" data-target="#bjax-target" data-el="#bjax-el" data-replace="true" class="text-ellipsis"
                              target="_blank">${newInfo.musicname}</a>
                              <a href="${pageContext.request.contextPath}/home/showSingerInfo?singer=${newInfo.singer}" 
                              target="_blank" class="text-ellipsis text-xs text-muted">${newInfo.singer}</a>
                            </div>
                          </div>
                        </div>
                        </c:forEach>
                    ...
                    <div class="col-md-5">
                      ...
                      <c:forEach items="${rank.list}" var="music" varStatus="status">                     
                        <a href="${pageContext.request.contextPath}/home/showMusic?musicId=${music.id}"
                         target="_blank" class="list-group-item clearfix">
                          <span class="pull-right h2 text-muted m-l"> <span style="color: #DC143C">${status.index + 1}</span></span>
                          <span class="pull-left thumb-sm avatar m-r">
                            <img src="http://localhost:8080/${music.image}" alt="...">
                          </span>
                          <span class="clear">
