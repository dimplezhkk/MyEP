                  ...
                  <section class="vbox animated fadeInUp">
                    <section class="scrollable hover">
                      <div id="menu" class="list-group no-radius no-border no-bg m-t-n-xxs m-b-none auto">
                        ...
                        <a href="${pageContext.request.contextPath}/hiphop" class="list-group-item active">
                          	嘻哈
                        </a>
                      </div>
                    </section>
                ...
                <section>
                  <section class="vbox">
                    <section class="scrollable padder-lg">
                      ...
                      <c:if test="${pageInfo.pageNum!=1}">
                      <li><a href="${pageContext.request.contextPath}/hiphop?page=${pageInfo.pageNum-1}"><i class="fa fa-chevron-left"></i></a></li>
                      </c:if>
                      ...
                      <!-- 判断当前页 -->
                        ...
                        <li class="active"><a href="#">${page}</a></li>
                      	...
                      	<c:if test="${pageInfo.pageNum!=page}">
                        <li><a href="${pageContext.request.contextPath}/hiphop?page=${page}">${page}</a></li>
                        </c:if>
                      </c:forEach>
                      <!-- 下一页 -->
                     ...
                     <c:if test="${pageInfo.pageNum!=pageInfo.pages}">
                     <li><a href="${pageContext.request.contextPath}/hiphop?page=${pageInfo.pageNum+1}"><i class="fa fa-chevron-right"></i></a></li>
                     </c:if>
                      </ul>
