                  ...
                  <div class="panel wrapper-lg">
                    <div class="row">
                      <div class="col-sm-5">
                        ...
                        <img src="http://localhost:8080/${album.image}" class="img-full m-b">
                      </div>
                      <div class="col-sm-7">
                        <h2 class="m-t-none text-black">${album.name}</h2>
                        <a href="${pageContext.request.contextPath}/home/showSingerInfo?singer=${album.singer}" target="_blank" class="jp-play-me m-r-sm pull-left">
                          ${album.singer}
                        </a>
                        <div class="m-b-lg">
                        </div>
                        <div style="padding-top: 30px;">
                        	  标签: <a href="javascript:void(0);" class="badge bg-light">${album.age}</a>
                        	  <a href="javascript:void(0);" class="badge bg-light">${album.area}</a>
                        	  <a href="javascript:void(0);" class="badge bg-light">${album.schools}</a>
                        </div>
                      </div>
                    </div>
                    <div class="m-t">
                    ...
                    <c:forEach items="${albumList}" var="album">
                      <article class="media">
                        ...
                        <div class="media-body">                        
                          ...
                          <div class="text-xs block m-t-xs"><a href="${pageContext.request.contextPath}/home/showSingerInfo?singer=${album.singer}">${album.singer}</a> ${album.age}</div>
                        </div>
                      </article>
                      </c:forEach>
                    </div>
