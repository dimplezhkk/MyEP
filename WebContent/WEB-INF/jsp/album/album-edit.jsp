        ...
        <div class="layui-fluid">
            <div class="layui-row">
                <form class="layui-form" method="post" enctype="multipart/form-data" id="file" action="#">
                	<input name="id" id="id" type="hidden" value="${album.id}">
                    <div class="layui-form-item">
                        <label for="name" class="layui-form-label">
                            <span class="x-red">*</span>专辑名称
                        </label>
                        <div class="layui-input-inline">
                            <input type="text" id="name" value="${album.name}" name="name" placeholder="请输入专辑名称" required="" lay-verify="required" autocomplete="off" class="layui-input">
                        </div>
                   ...
                   <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="singer" value="${album.singer}" name="singer" placeholder="请输入专辑歌手" required="" lay-verify="required" autocomplete="off" class="layui-input">
                        </div>
                   </div>
                  ...
                  <div class="layui-inline">
                   ...
                   <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <button class="layui-btn" lay-filter="add" lay-submit="">修改专辑</button>
        ...
        layui.use(['form', 'layer','jquery'],
            function() {
                ...
                function(data) {
                    ...
                    $.ajax({
                    	type: 'post',
                        url: '${pageContext.request.contextPath}/album/editAlbum',
                        cache: false,
                        async: true,
                        data: selectedFile,
